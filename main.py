...
def main(args):
    ...
    args.max_steps=len(data_module.trainset) * args.max_epochs // (args.accumulate_grad_batches * args.batch_size) + 8

    # If you wnat Tensorboard
    #logger = TensorBoardLogger(save_dir='./log/', name=args.log_dir)
    logger = WandbLogger(name='Yours',project='Yours')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--reverse_weight', default=0.01, type=float)
